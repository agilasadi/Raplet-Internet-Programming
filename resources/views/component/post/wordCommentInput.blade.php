@if(Auth::check())
        ...
        <div class="commentOutherBeforePlaceholder" style="display: block;">
            <div class="commentBeforePlaceholder @if(count($comments) < 1) noCommentsHere @endif">
                <div class="wordHeaderOwnerImage">
                    <img class="roundimg"
                         src="{{url('storage/profile/'. Auth::user()->userprofile->userImg)}}" alt="...">
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="enterYourCommentPlaceholder"
                           aria-describedby="emailHelp" placeholder="{{ trans('home.addyourcomment') }}">
                </div>
                <div class="commentBeforeFieldButtonPreview"><i class="fas fa-paperclip"></i></div>
            </div>
        </div>
                            ...
                            <div class="form-group commentTextareField transitionSlow">
                                ...
                                <div class="manageCommentSection">
                                    ...
                                    <div class="managerButtons float-right">
                                        ...
                                        <button id="closeCommentSection" class="border-right-line">
                                            <i class="far fa-window-minimize"></i></button>
                                        <button id="clearCommentSection" class="">
...
@else
    <div class="commentOutherBeforePlaceholder" style="display: block;">
        <div class="commentBeforePlaceholder @if($comments != null) noCommentsHere @endif">
                <div class="wordHeaderOwnerImage">
                    <img class="roundimg" src="{{url('storage/profile/profile.jpg') }}" alt="...">
                </div>
            <div class="form-group">
